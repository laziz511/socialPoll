...
<head>
    ...
    <link href="css/admin/admin-dashboard.css" rel="stylesheet" type="text/css" media="all" />
                    ...
                    <div id="questions-container">
                        <c:forEach items="${poll.questions}" var="question" varStatus="counter">
                            <div class="question-container" id="question-${question.id}">
                                ...
                                <input type="text" name="question_${question.id}" value="${question.questionText}"
                                    required readonly>

                                <label>Answer Options:</label>
                                <c:forEach items="${question.options}" var="option">
                                    <input type="text" id="option_${option.id}" name="option_${option.id}"
                                        value="${option.optionText}" required readonly>
                                </c:forEach>
